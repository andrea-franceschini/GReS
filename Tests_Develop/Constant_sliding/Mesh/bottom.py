...
P2 = gmsh.model.occ.addPoint(2,   0,     zMin)
P3 = gmsh.model.occ.addPoint(2,   2.7,   zMin)
P4 = gmsh.model.occ.addPoint(0,     0.7,   zMin)
...
outExtrude = gmsh.model.occ.extrude([(2, surf1)], 0, 0, 0.5, numElements=[NZ], recombine=flagRecombine)
...
gmsh.model.addPhysicalGroup(2, [outExtrude[2][1]], 1, name="y_fixed")
gmsh.model.addPhysicalGroup(2, [surf1,outExtrude[0][1]], 2, name="z_fixed")
gmsh.model.addPhysicalGroup(2, [outExtrude[4][1]], 3, name="interface")
gmsh.model.addPhysicalGroup(3, [outExtrude[1][1]], 1, name="bottom_block")
