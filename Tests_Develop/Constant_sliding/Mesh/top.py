...
P1 = gmsh.model.occ.addPoint(0,     0.7,     0)
P2 = gmsh.model.occ.addPoint(2,    2.7,     0)
P3 = gmsh.model.occ.addPoint(2,   4,   0)
P4 = gmsh.model.occ.addPoint(0,     4,   0)
...
gmsh.model.addPhysicalGroup(2, [outExtrude[2][1]], 1, name="interface")
gmsh.model.addPhysicalGroup(2, [surf1,outExtrude[0][1]], 2, name="z_fixed")
gmsh.model.addPhysicalGroup(2, [outExtrude[4][1]], 3, name="top_load")
gmsh.model.addPhysicalGroup(3, [outExtrude[1][1]], 1, name="top_block")
