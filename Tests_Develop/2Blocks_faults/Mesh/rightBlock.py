...
gmsh.model.addPhysicalGroup(2, [outExtrude[5][1]], 1, name="interface")
gmsh.model.addPhysicalGroup(2, [surf1], 2, name="bottom")
gmsh.model.addPhysicalGroup(2, [outExtrude[3][1]], 3, name="lateral")
gmsh.model.addPhysicalGroup(2, [outExtrude[0][1]], 4, name="topLoad")
gmsh.model.addPhysicalGroup(3, [outExtrude[1][1]], 1, name="right_block")
