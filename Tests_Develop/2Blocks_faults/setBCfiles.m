...
writeBCfiles('BCs/rightLatLoad','SurfBC','Neu',{'Poromechanics','x'},'right_latLoad',[0 1 7],[0 -5 -5],rightMesh,2); % right block bottom fix
writeBCfiles('BCs/rightTopLoad','SurfBC','Neu',{'Poromechanics','z'},'right_topLoad',[0 1 7],[0 0 -18],rightMesh,3); % right block bottom fix
