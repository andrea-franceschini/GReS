function [info, present] = dataset_norne_ensemble()
...
%}
    ...
    [info, present] = datasetInfoStruct(...
        'name', 'Norne_Ensemble', ...
        'website', 'https://github.com/rolfjl/Norne-Initial-Ensemble', ...
        'fileurl', '', ...
        'downloadFcn', @() downloadNorneEnsembleFiles(), ...
        'filesize', 5.6,...
        'hasGrid', false, ...
        'hasRock', false, ...
        'hasFluid', false, ...
        'examples', {'network-models:showNorne', ...
        }, ...
