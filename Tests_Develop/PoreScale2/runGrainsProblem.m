...
interf = load('Interface_grain.mat');
interfaces_g2g = interf.interfaces_g2g;

dom = load('domains_grain.mat');
domains = dom.domains;
...
%%
solver = MultidomainFCSolver(simParam,domains,interfaces_g2g);
