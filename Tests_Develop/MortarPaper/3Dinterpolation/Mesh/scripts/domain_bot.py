...
outExtr = gmsh.model.occ.extrude([(2, bot)], 0, 0, 0.1, numElements=[1], recombine=recombineFlag)
...
gmsh.model.mesh.set_transfinite_curve(L1l,N+1)
gmsh.model.mesh.set_transfinite_curve(L2l,N+1)
gmsh.model.mesh.set_transfinite_curve(L3l,N+1)
gmsh.model.mesh.set_transfinite_curve(L4l,N+1)

gmsh.model.mesh.set_transfinite_surface(1)

gmsh.model.addPhysicalGroup(2, [outExtr[0][1]], 1, name="interf")

gmsh.model.addPhysicalGroup(outExtr[1][0], [outExtr[1][1]], 1, name="botMesh")
