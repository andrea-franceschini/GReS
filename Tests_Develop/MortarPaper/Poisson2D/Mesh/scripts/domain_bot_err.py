...
gmsh.model.mesh.set_transfinite_curve(L1l,6)
gmsh.model.mesh.set_transfinite_curve(L2l,4)
gmsh.model.mesh.set_transfinite_curve(L3l,6)
gmsh.model.mesh.set_transfinite_curve(L4l,4)

gmsh.model.mesh.set_transfinite_surface(1)

gmsh.model.addPhysicalGroup(1, [L3l], 1, name="interf")
gmsh.model.addPhysicalGroup(1, [L1l,L2l,L4l], 2, name="bound")


gmsh.model.addPhysicalGroup(2, [1], 1, name="botMesh")
