...
gmsh.model.mesh.set_transfinite_curve(L1l,14)
gmsh.model.mesh.set_transfinite_curve(L2l,8)
gmsh.model.mesh.set_transfinite_curve(L3l,14)
gmsh.model.mesh.set_transfinite_curve(L4l,8)
