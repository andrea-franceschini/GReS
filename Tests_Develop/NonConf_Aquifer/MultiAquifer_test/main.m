...
d1.importGMSHmesh('Mesh/L1.msh');
d2.importGMSHmesh('Mesh/L2.msh');
d3.importGMSHmesh('Mesh/L3.msh');
d4.importGMSHmesh('Mesh/L4.msh');
d5.importGMSHmesh('Mesh/L5.msh');
% 
...
% % 
% % % %% Utils
% % writeBCfiles('inj_L2','NodeBC','Dir','Flow',[],'injection_L2',[0 1 5 6 100],[0 100 100 0 0],[201 205]);
% % writeBCfiles('erog_L4','NodeBC','Dir','Flow',[],'withdraw_L4',[0 1 100],[0 -100 -100],153);
% % writeBCfiles('inj_L4','NodeBC','Dir','Flow',[],'injection_L4',[0 1 100],[0 100 100],159);
%writeBCfiles('bot_fix_L5','NodeBC','Dir','Poro',["x","y","z"],'fixed_bottom',0,0,d5,2);
