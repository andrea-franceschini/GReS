...
%%
%nL2 = find(any([d2.coordinates(:,1)==0, d2.coordinates(:,2)==0, d2.coordinates(:,1)==2000, d2.coordinates(:,2)==2000],2));
%nL4 = find(any([d4.coordinates(:,1)==0, d4.coordinates(:,2)==0, d4.coordinates(:,1)==2000, d4.coordinates(:,2)==2000],2));


%% Utils
% bot_nodes = load('bot_nodes');
% writeBCfiles('imp_L2','NodeBC','Dir','Flow',[],'injection_L2',0,0,nL2);
% writeBCfiles('imp_L4','NodeBC','Dir','Flow',[],'injection_L4',0,0,nL4);
