...
% fileName = ["dirNodeLatSurf_hexa_SS.dat","neuNode.dat"];   % FEM
fileName = ["dirSurfLatSurf_hexa_SS.dat","neuVol.dat"];   % FVTPFA
%
% For transient simulations
% fileName = ["dirNodeLatSurf_hexa.dat","neuNode.dat"];   % FEM
% fileName = ["dirSurfLatSurf_hexa.dat","neuVol.dat"];   % FVTPFA
%
