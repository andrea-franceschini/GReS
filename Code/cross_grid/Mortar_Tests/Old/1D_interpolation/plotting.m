...
loglog(h,L2eb,'k-','LineWidth',1.2,'Marker','s','MarkerSize',ms)
hold on
%loglog(h,L2g4,'k-','LineWidth',1,'Marker','*','MarkerSize',ms)
loglog(h,L2g6,'k-','LineWidth',1.2,'Marker','^','MarkerSize',ms)
%loglog(h,L2g8,'k-','LineWidth',1,'Marker','s','MarkerSize',ms)
loglog(h,L2w6,'k-','LineWidth',1.2,'Marker','o','MarkerSize',ms)
%grid on
xlabel('h')
...
leg = legend('Element based', 'RBF Gaussian - n_M = 6','RBF Wendland - n_M = 6');
...
% %     % set(get(allAxes(i), 'YLabel'), 'FontName', 'Times', 'FontSize', 12);
% % end
% legend('Element based', 'RBF Gaussian - n_M = 6','RBF Wendland - n_M = 6');
% %leg.Layout.Tile = 'north';
% legend boxoff    
