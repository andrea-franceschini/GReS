...
fileNameTop = 'Mesh_flat/TopBlock_tetra.msh';
fileNameBottom = 'Mesh_flat/BottomBlock_tetra.msh';
...
% get top node (it has half of the entities influence)
id = topMesh.coordinates(nodesFixX,2)-1<1e-3; % dont constraint slave interface node!
nodesFixX = nodesFixX(~id);
...
integration = "RBF"; % RBF or SB
mult_type = 'dual';
solution_scheme = "COND"; % SP (saddle point) % COND (condensated)
