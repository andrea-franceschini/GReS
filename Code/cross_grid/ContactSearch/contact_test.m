...
msh1 = Mesh();
msh2 = Mesh();
msh1.importGMSHmesh('3Dmesh/Mesh_coarse.msh');
msh2.importGMSHmesh('3Dmesh/Mesh_fine.msh');
% msh1.computeSurfaceCentroid();
% msh2.computeSurfaceCentroid();
cs = ContactSearching(msh1,msh2,18);

plotFunction(msh1, 'out_coarse', zeros(msh1.nNodes,1))
plotFunction(msh2, 'out_fine', zeros(msh2.nNodes,1))
