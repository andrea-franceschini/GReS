...
plot(x,f(x),'r')
hold on
plot(master(mortar.nodesMaster,1),f(master(mortar.nodesMaster,1)),'rs')
plot(slave(mortar.nodesSlave,1),E_EB*f(master(mortar.nodesMaster,1)),'g-s')
plot(slave(mortar.nodesSlave,1),E_RBF*f(master(mortar.nodesMaster,1)),'b-s')
plot(slave(mortar.nodesSlave,1),E_SB*f(master(mortar.nodesMaster,1)),'m-s')
legend('anal','','eb','rbf','sb')
