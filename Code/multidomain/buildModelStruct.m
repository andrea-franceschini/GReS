function modStruct = buildModelStruct(model,simParam,fName)
...
while ~feof(fID)
    ...
    if ~isempty(line) && ~strcmp(line(1),'%')
        ...
        modStruct = [modStruct;struct('id',c,'DomainName',name,'Grid',grid,'Material',mat,...
            'DoFManager',dof,'BoundaryConditions',bc,'State',state,...
            'OutState',printUtils,'Discretizer',linSyst)];
    end
end
end
