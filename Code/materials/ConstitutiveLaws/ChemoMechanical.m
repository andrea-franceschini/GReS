classdef ChemoMechanical < handle
  ...
  methods (Access = public)
    ...
    function obj = ChemoMechanical(fID, matFileName, varargin)
       if nargin > 2
          obj.isTabular = true;
    ...
    function [DAll, sigmaOut, status] = getStiffnessMatrix(obj, sigmaIn, epsilon, dt, status, cellID, p)
