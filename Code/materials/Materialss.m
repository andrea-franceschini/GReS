classdef Materialss < handle
  ...
  methods (Access = public)
    ...
    function obj = Materialss(input)

      obj.solid = struct('data',[]);
      obj.fluid = struct('data',[]);
    ...
    % function data = getProp(obj,Mat,Prop,Id)
    %   check
    % 
    % end
    ...
    function addFluid(obj,varargin)
      ...
      default = struct('name',string(strcat('mat_',num2str(matID))) );
      params = readInput(default,varargin{:});



      nfluid = numel(obj.fluid);
