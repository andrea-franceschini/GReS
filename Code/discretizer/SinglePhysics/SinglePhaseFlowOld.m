classdef SinglePhaseFlowOld < SinglePhysics
  %POROMECHANICS
  ...
  methods (Access = public)
    function obj = SinglePhaseFlowOld(symmod,params,dofManager,grid,mat,bc,state)
    ...
    function [cellData,pointData] = printState(obj,sOld,sNew,t)
      ...
      [cellData,pointData] = SinglePhaseFlowOld.buildPrintStruct(obj.model,outPrint);
    end
