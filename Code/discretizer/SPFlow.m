classdef SPFlow < handle
    ...
    methods (Access = public)
        ...
        function computeMatFEM(obj) %provisional method exploiting dof manager workflow
            subInd = obj.dofm.subList(ismember(obj.dofm.subPhysics, 'Flow'));
            ...
            for el = subCells'
                ...
                dof = obj.dofm.ent2field('Flow',obj.mesh.cells(el,1:obj.mesh.cellNumVerts(el)));
        ...
        function computeStiffMatFV(obj,lw)
            ...
            neigh1dof = obj.dofm.ent2field('Flow',neigh1);
            neigh2dof = obj.dofm.ent2field('Flow',neigh2);
        ...
        function computeCapMatFV(obj,varargin)
            ...
            dof = obj.dofm.ent2field('Flow', subCells);
        ...
        function computeRHSGravTerm(obj)
            ...
            if gamma > 0
                ...
                if isFEMBased(obj.model,'Flow')
                    ...
                    obj.rhsGrav = rhsTmp(obj.dofm.getDoF('Flow'));
                elseif isFVTPFABased(obj.model,'Flow')
                    intFaces = any(obj.isIntFaces(:,subInd),2);
        ...
        function gTerm = finalizeRHSGravTerm(obj,lw)            
            ...
            intFaces = any(obj.isIntFaces(:,subInd),2);
            neigh = obj.faces.faceNeighbors(intFaces,:);
            neigh = obj.dofm.ent2field('Flow',neigh);
        ...
        function blk = blockRhs(obj, fld)
            if ~strcmp(obj.dofm.subPhysics(fld), 'Flow')
