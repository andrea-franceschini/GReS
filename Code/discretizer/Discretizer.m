...
%         end
      ...
      obj.KPoro = sparse(iiVec,jjVec,KVec,obj.mesh.nNodes*obj.mesh.nDim, ...
                     obj.mesh.nNodes*obj.mesh.nDim);
      %obj.rhsPoro = obj.KPoro*state.displ;
    end
...
%         obj.computeFlowRHSGravContribute();
        ...
        obj.rhsPoro = theta*obj.KPoro*stateTmp.displ - theta*obj.Q*stateTmp.pressure + ...
            (1-theta)*(obj.KPoro*statek.displ-obj.Q*statek.pressure);
        
        obj.rhsFlow = obj.rhsFlow + ((obj.Q)'/dt)*stateTmp.displ+(theta*obj.H+obj.P/dt)*stateTmp.pressure +...
            (1-theta)*obj.H*statek.pressure -(1/dt)*((obj.Q)'*statek.displ+obj.P*statek.pressure);
        
       %construct Jacobian and rhs for Coupled System
        obj.K = [theta*obj.KPoro, -theta*obj.Q; (obj.Q)'/dt, theta*obj.H+obj.P/dt];
