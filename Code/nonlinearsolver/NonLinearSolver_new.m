classdef NonLinearSolver_new < handle
...
%     BCName
  ...
  methods (Access = public)
      function obj = NonLinearSolver_new(symmod,simParam,dofManager,grid,mat,bc,prtUtil,stateIni,varargin)
    ...
    function [simStat] = NonLinearLoop(obj)
      ...
      if obj.elements.nCellsByType(2) > 0  % There is at least one hexahedron
        linSyst = Discretizer_new(obj.model,obj.simParameters,obj.dofManager,obj.grid,obj.material, ...
                  obj.GaussPts);
      else
        linSyst = Discretizer_new(obj.model,obj.simParameters,obj.dofManager,obj.grid,obj.material);
      end
