...
for i=1:length(meshList)
    ...
    fileName = setRichardsBC(input_dir,grid,cond);
...
stmp = strcat(figures_dir,'Varelha_mesh_conv_head_pressure','.png');
...
set(gca,'FontName', 'Liberation Serif', 'FontSize', 16, 'XGrid', 'on', 'YGrid', 'on')
% export figure with quality
stmp = strcat(figures_dir, 'Varelha_mesh_conv_saturation', '.png');
exportgraphics(gcf,stmp,'Resolution',400)
