...
%}
    [info, present] = datasetInfoStruct(...
        'name', 'CO2Atlas Barents Sea', ...
        'website', 'http://www.npd.no/en/Publications/Reports/CO2-storage-atlas-Barents-Sea/', ...
        'fileurl', 'https://www.sintef.no/contentassets/124f261f170947a6bc51dd76aea66129/CO2Atlas_BarentsSea.zip', ...
        'hasGrid', true, ...
        'hasRock', false, ...
        'description', ['The Norwegian Petroleum Directorate has produced ' ...
                        ...
                        'formations in the Barents Sea.  It includes thickness ' ...
