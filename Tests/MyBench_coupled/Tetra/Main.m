...
%
% Set the input file
fileName = ["dir_BC_flow_tetra.dat","dir_BC_poro_tetra.dat","neu_BC_flow_tetra.dat"];
%
...
% end
%
%list of nodes for solution output
listZ = [1,17:35,5];
uX = resState.displ(3*listZ-2);
uY = resState.displ(3*listZ-2);
uZ = resState.displ(3*listZ);
p = resState.pressure(listZ);
