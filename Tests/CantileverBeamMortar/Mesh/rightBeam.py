...
gmsh.model.addPhysicalGroup(2, [loop1], 1, name="interface_right")
gmsh.model.addPhysicalGroup(2, [outExtrude[0][1]], 2, name="fix_right")
gmsh.model.addPhysicalGroup(3, [outExtrude[1][1]], 1, name="right_beam")
