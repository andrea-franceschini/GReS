...
fileName = "simParam_mech_contact.dat";
...
printUtils = OutState(model,mesh,'outTime.dat','folderName','Faulted_aquifer_contact','flagMatFile',false);
...
interfaces{1}.solvers(2).simparams.setVerbosity(3);
...
depth = abs(max(interface.mesh.msh(2).surfaceCentroid(:,3)) - interface.mesh.msh(2).surfaceCentroid(:,3));
